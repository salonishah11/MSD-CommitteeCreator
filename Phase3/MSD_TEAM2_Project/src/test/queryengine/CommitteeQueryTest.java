...
public class CommitteeQueryTest {
	...
	public void testCreateQuery(){
		...
		a.setType("phdthesis");
		a.setYear(2017);
		String query = cq.createInsertQuery(a);
		assertTrue("Insert query creation failed", query.equals("insert into dblp.shortlistcommittee (`authorname`, `year`, `ownerusername`, `keyval`, `papertype`) values('Frank Tip','2017','Michelle90','journals/ecoop','phdthesis');"));
	}
	...
	public void testForRemoveMembers(){
		...
		Main.setCurrentUser(currentUser);
		CommitteeQuery cq = new CommitteeQuery();
		ArrayList<Author> auths = cq.getUsersCommitteeList(currentUser);
		boolean flag=false;
