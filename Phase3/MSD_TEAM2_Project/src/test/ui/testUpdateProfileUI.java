...
public class testUpdateProfileUI {
	...
	public void testUpdateProfileFailure1(){
		...
		assertNotEquals(responseFirstNameMsg, upui1.firstNameField.getText());
		assertNotEquals(responseLastNameMsg, upui1.lastNameField.getText());
		assertNotEquals(responseEmailMsg, upui1.emailField.getText());
		assertNotEquals(responsePhoneMsg, upui1.phoneField.getText());
		assertEquals(responseDesignationMsg, upui1.designationField.getSelectedItem());
		assertNotEquals(responseUserNameMsg, upui1.usernameField.getText());
	...
	public void testUpdateProfileFailure2(){
		...
		assertNotEquals(responsePasswordMsg, String.valueOf(upui.passwordField.getPassword()));
	} 
