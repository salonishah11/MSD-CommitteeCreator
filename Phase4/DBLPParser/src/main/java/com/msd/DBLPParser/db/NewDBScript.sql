CREATE DATABASE  IF NOT EXISTS `dblp_full` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `dblp_full`;
...
`keyVal` varchar(255) NOT NULL,
  ...
  `crossRef` varchar(255) DEFAULT NULL,
  `bookTitle` varchar(255) DEFAULT NULL,
`authorname` varchar(2500) DEFAULT NULL,
...
DROP TABLE IF EXISTS `journalauthor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
DROP TABLE IF EXISTS `wwwauthor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `wwwauthor` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `keyVal` varchar(255) DEFAULT NULL,
  `authorName` varchar(255) DEFAULT NULL,
  `type` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `thesisauthor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `affiliation` (
  `authorname` varchar(255) NOT NULL,
  `university` varchar(2000) DEFAULT NULL,
...
CREATE TABLE `universitydetails` (
  ...
  `region` varchar(2000) DEFAULT NULL,
...
`researcharea` varchar(2000) DEFAULT NULL,
`countno` int(11) DEFAULT 0,
`adjustedcountno` int(11) DEFAULT 0,
